...
let SQLiteFactory, SQLitePlugin, SQLitePluginTransaction, SelfTest, argsArray, dblocations, iosLocationMap, newSQLError, nextTick, root, txLocks;
...
SQLitePluginTransaction.prototype.addStatement = function (sql, values, success, error) {
    let j, len1, params, sqlStatement, t, v;
...
SQLitePluginTransaction.prototype.run = function () {
    let batchExecutes, handlerFor, i, mycb, mycbmap, request, tropts, tx, txFailure, waiting;
    txFailure = null;
    tropts = [];
    ...
    mycb = function (result) {
        ...
        for (resultIndex = j = 0, ref = result.length - 1; ref >= 0 ? j <= ref : j >= ref; resultIndex = ref >= 0 ? ++j : --j) {
...
SQLiteFactory = {
    ...
    */
    openDatabase: argsArray(function (args) {
        let dblocation, errorcb, okcb, openargs;
                    ...
                    return db.transaction(function (tx) {
                        ...
                        return db.readTransaction(function (tx2) {
                            return tx2.executeSql('SELECT id, data FROM TestTable', [], function (ignored, resutSet2) {
                                ...
                                return readTransactionFinished;
                            });
                        }, function (tx2_err) {
                            ...
                            return db.transaction(function (tx3) {
                                ...
                                let secondReadTransactionFinished;
                                ...
                                return db.readTransaction(function (tx4) {
                                    return tx4.executeSql('SELECT id, data FROM TestTable', [], function (ignored, resutSet3) {
                                        ...
                                        return secondReadTransactionFinished;
                                    });
                                }, function (tx4_err) {
